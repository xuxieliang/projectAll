...
- (void)viewDidLoad {
    ...
    [shareButton setBackgroundImage:[UIImage imageNamed:@"fenxiangN"] forState:(UIControlStateNormal)];
    [shareButton setBackgroundImage:[UIImage imageNamed:@"fenxiangH"] forState:(UIControlStateHighlighted)];
